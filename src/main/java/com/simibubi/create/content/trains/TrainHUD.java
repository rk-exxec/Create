...
public class TrainHUD {
	...
	public static void renderOverlay(ForgeGui gui, GuiGraphics graphics, float partialTicks, int width,
		...
		graphics.blit(AllGuiTextures.TRAIN_HUD_SPEED.getLocation(), 0, 0, 0, AllGuiTextures.TRAIN_HUD_SPEED.getStartX(),
		...
		if (promptSize > 1) {
			...
			graphics.blit(AllGuiTextures.TRAIN_PROMPT.getLocation(), 0, 0, 0, AllGuiTextures.TRAIN_PROMPT.getStartX() + (128 - promptSize / 2f),
		...
		graphics.blit(AllGuiTextures.TRAIN_HUD_THROTTLE.getLocation(), invW, 0, 0, AllGuiTextures.TRAIN_HUD_THROTTLE.getStartX() + invW,
