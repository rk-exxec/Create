...
public class TrainHUD {
	...
	private static void renderOverlay(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
		...
		guiGraphics.blit(AllGuiTextures.TRAIN_HUD_SPEED.getLocation(), 0, 0, 0, AllGuiTextures.TRAIN_HUD_SPEED.getStartX(),
		...
		if (promptSize > 1) {
			...
			guiGraphics.blit(AllGuiTextures.TRAIN_PROMPT.getLocation(), 0, 0, 0, AllGuiTextures.TRAIN_PROMPT.getStartX() + (128 - promptSize / 2f),
		...
		guiGraphics.blit(AllGuiTextures.TRAIN_HUD_THROTTLE.getLocation(), invW, 0, 0, AllGuiTextures.TRAIN_HUD_THROTTLE.getStartX() + invW,
